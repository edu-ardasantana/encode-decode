function addText(text) {
    var output_field = document.querySelector(".msg-resultado");
    var noOutput_div = document.querySelector(".sem-msg");
    var output_div = document.querySelector(".saida");
...
function errorText(erro) {
    ...
    var noOutput_title = document.querySelector(".title-sem-msg");
    var noOutput_text = document.querySelector(".text-sem-msg");

    noOutput_title.innerHTML = "Erro durante ação";

    noOutput_text.innerHTML = erro;
...
function encrypt() {
    var elementMessage = document.querySelector(".entrada-msg");
